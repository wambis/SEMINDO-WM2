...
class NDKFile(object):
    ...
    def findname(self,name):
        ...
        #    print(err)
            ...
            cmtname = name #brk2cmt(name)
            print('couldn\'t find 14 char event: %s'%name)
...
class NDKEvent(object):
    def __init__(self,ndkblock):
        ...
        self.first_line= ndkblock[0]

        #inversion information:
        self.cmtid         = ndkblock[1][:15].strip()
        #half duration:
        self.half_duration = ndkblock[1][76:82].strip()
        # time shift
        self.time_shift    = ndkblock[2][14:18].strip()
        ...
        #wamba
        self.cdepth    = float(ndkblock[2][48:54])
        ...
        #Scalar Moment M0
        self.M0    = float(ndkblock[4][49:57])*exp
