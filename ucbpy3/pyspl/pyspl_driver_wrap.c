...
SWIGINTERN PyObject *_wrap__bspl_driver(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOO:_bspl_driver",&obj0,&obj1,&obj2,&obj3,&obj4)) SWIG_fail;
...
SWIGINTERN PyObject *_wrap__sspl_driver(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOOOOOO:_sspl_driver",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5,&obj6,&obj7,&obj8)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"_bspl_driver", _wrap__bspl_driver, METH_VARARGS, NULL},
	 { (char *)"_sspl_driver", _wrap__sspl_driver, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
